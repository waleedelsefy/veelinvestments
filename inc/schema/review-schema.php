...
function veel_add_review_meta_box() {
    add_meta_box(
        ...
        __('مراجعة الخبير العقاري', 'veelinvestments'),
...
function veel_review_meta_box_callback($post) {
    ...
    <p>
        <label for="expert_review_enabled">
            ...
            <?php _e('تفعيل سكيما مراجعة الخبير العقاري', 'veelinvestments'); ?>
        </label>
    </p>
    <table style="width: 100%;">
        <tr>
            <td style="width: 30%; vertical-align: top;">
                <label for="expert_reviewer_id"><?php _e('المراجع:', 'veelinvestments'); ?></label>
            </td>
            <td>
                <select name="expert_reviewer_id" id="expert_reviewer_id" style="width: 50%;">
                    <option value=""><?php _e('اختر المراجع', 'veelinvestments'); ?></option>
                    <?php
        ...
        <tr>
            <td style="vertical-align: top;">
                <label for="expert_review_rating"><?php _e('التقييم (من 1 إلى 5):', 'veelinvestments'); ?></label>
            </td>
            <td>
                <select name="expert_review_rating" id="expert_review_rating" style="width: 100px;">
                    <option value=""><?php _e('اختر التقييم', 'veelinvestments'); ?></option>
                    <?php
                    for ($i = 1; $i <= 5; $i++) {
        ...
        <tr>
            <td style="vertical-align: top;">
                <label for="expert_review_content"><?php _e('نص المراجعة:', 'veelinvestments'); ?></label>
            </td>
            <td>
