  ...
  <div class="veelLatestProjects">
    ...
    <div class="veelLatestProjectsSubHeading">
      <div class="subHeadingParagraph">
        <p>احدث اخبار العقارات في جميع مشروعات شركئنا سكنية, تجارية و ادارية</p>
      </div>
      <div class="veelLatestProjectsHeaderShowAll desktopOnly">
        <a class="veelLatestProjectsHeaderShowAll desktopOnly">عرض الكل</a>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    const latestProjectsSectionrightArrow = document.getElementById('latestProjectsSectionright-arrow');
    const latestProjectsSectionleftArrow = document.getElementById('latestProjectsSectionleft-arrow');

    latestProjectsSectionrightArrow.addEventListener('click', function() {
      veelLatestProjectsImageGallery.scrollBy({ left: 300, behavior: 'smooth' });
    });

    latestProjectsSectionleftArrow.addEventListener('click', function() {
      veelLatestProjectsImageGallery.scrollBy({ left: -300, behavior: 'smooth' });
    });
  });
</script>
