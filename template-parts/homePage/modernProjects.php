<div class="modernProjects-MC">
    <div class="first-section">
        ...
        <div class="first-section-subtitle-and-displayAll">
            <div class="first-first-section-subtitle">
                <p>ابحث في مجموعة من ارقى العقارات بأفضل الأسعار</p>
            </div>
            <div class="display-all">
                <a class="text-display" href="">عرض الكل</a>
        ...
        <div class="carousel-container">
            <div class="nav-button-next" id="nextBtn-modern-projects">
            ...
            <div class="carousel-wrapper">
                <div class="carousel-modern-projects">
                    <div class="card">
                        <img class="card-image" src="<?php echo get_template_directory_uri(); ?>/src/image/0486bf252de1c93baa98efdbd083a44c.png">
                        <span class="card-heading">اسم المشروع</span>
                        <p class="card-subtitle">مدينة مصر</p>
                    </div>
                    <div class="card">
                        <img class="card-image" src="<?php echo get_template_directory_uri(); ?>/src/image/a09b7bf9eba9619b205b3cf735133238.png">
                        <span class="card-heading">اسم المشروع</span>
                        <p class="card-subtitle">مدينة مصر</p>
                    </div>
                    <div class="card">
                        <img class="card-image" src="<?php echo get_template_directory_uri(); ?>/src/image/4ffcec666cc536974c9768d45debf05b.png">
                        <span class="card-heading">اسم المشروع</span>
                        <p class="card-subtitle">نايل للتطوير العقاري</p>
                    </div>
                    <div class="card">
                        <img class="card-image" src="<?php echo get_template_directory_uri(); ?>/src/image/0486bf252de1c93baa98efdbd083a44c.png">
                        <span class="card-heading">اسم المشروع</span>
            ...
            <div class="nav-button-prev" id="prevBtn-modern-projects">
                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
...
<div class="display-all-for-mobile-first-section">
    <p class="text-display-for-mobile">عرض الكل </p>
    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="15" viewBox="0 0 8 15" fill="none">
        <path d="M2.32537 7.39485L7.43045 12.4959C7.80801 12.8735 7.80801 13.484 7.43045 13.8575C7.05289 14.2311 6.44237 14.2311 6.06481 13.8575L0.280927 8.07767C-0.0845857 7.71216 -0.0926156 7.12574 0.252809 6.74818L6.0608 0.928141C6.24958 0.739363 6.49861 0.64698 6.74362 0.64698C6.98863 0.64698 7.23766 0.739363 7.42644 0.928141C7.80399 1.3057 7.80399 1.91622 7.42644 2.28976L2.32537 7.39485Z" fill="black"/>
    </svg>
</div>
<div class="bar-first-section"></div>