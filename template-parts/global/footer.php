...
$sales_number = isset($theme_settings['sales_number']) ? esc_attr($theme_settings['sales_number']) : '01040300143';
$email = isset($theme_settings['email']) ? esc_attr($theme_settings['email']) : 'sales@veelinvestments.com';
$address = isset($theme_settings['address']) ? esc_attr($theme_settings['address']) : 'مكتب ٢٠٢ مبنى ٣٤ أ الملتقى العربي - شيراتون - مصر الجديدة';
$about_us = isset($theme_settings['about_us']) ? esc_attr($theme_settings['about_us']) : '';
...
<div class="veelFooter">
  ...
  <div class="logoandSocial">
    <div class="footerLogo">
      <img src="<?php echo esc_url(get_template_directory_uri() . '/src/img/veel-footer-logo.webp'); ?>">
    </div>
    <div class="social">
  ...
  <div class="quickLinks">
    <div class="quickLinksHeader"> روابط سريعة
  ...
  <div class="contactUs">
    <div class="cntactUsHeader">تواصل معنا
      <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
        <path d="M14.0604 13.352L8.07919 19.3333L6.37061 17.6247L14.0604 9.93484L21.7503 17.6247L20.0417 19.3333L14.0604 13.352Z" fill="white"/>
      </svg>
    </div>
    ...
    <div class="veelPhoneCall">
      ...
      <a href="<?php echo 'tel:+2' . $phone_number; ?>"><?php echo $phone_number; ?></a>
    </div>
