<div class="veelFooter">
  ...
  <div class="logoandSocial">
    <div class="footerLogo"><img src="<?php echo esc_url(get_template_directory_uri() .'/src/img/veel-footer-logo.webp'); ?>"> </div>
    <div class="social"> <?php get_template_part('template-parts/global/social'); ?> </div>
  </div>
  ...
  <div class="quickLinks">
    <div class="quickLinksHeader"> روابط سريعة<svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
  ...
  <div class="contactUs">
    <div class="cntactUsHeader">تواصل معنا <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
      <path d="M14.0604 13.352L8.07919 19.3333L6.37061 17.6247L14.0604 9.93484L21.7503 17.6247L20.0417 19.3333L14.0604 13.352Z" fill="white"/>
    </svg></div>
    ...
    <div class="veelGmailContent">
      <div class="gmailIcon"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" viewBox="0 0 20 14" fill="none">
      ...
      <div class="veelGmail">Johnesmat62@gmail.com</div>

    </div>
    <div class="veelLocationContent">
      <div class="locationIcon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="22" viewBox="0 0 18 22" fill="none">
      ...
      <div class="veelLocation">هو ببساطة نص شكلي (بمعنى أن الغاية هي الشكل وليس المحتوى) ويُستخدم في صناع</div>
